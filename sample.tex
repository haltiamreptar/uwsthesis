...
%% options nosoo or soo (default) or revsoo don't put/put a Statement Of Originality (you probably should accept the default here), revsoo uses the revdate instead of subdate
